...
import { MSH } from './hl7-parser/models/segments/msh';
let sampleMessage = `MSH|^~\&|SENDING^APPLICATION|SENDING_FACILITY|RECEIVING_APPLICATION|RECEIVING_FACILITY|20110613072836||SIU^S14|24916579|P|2.3||||||
